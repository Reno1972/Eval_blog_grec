                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 offset-md-1 py-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="inscription.php?inscription" class="text-white">S'inscrire</a></li>
                            <li>
                    ...
                    foreach ($allArticles as $value) {
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <div class="m-3">
                                    <a href="presentation.php?afficheTitle=<?= $value->titre_article ?>&afficheText=<?= $value->text_article ?>&affichePseudo=<?= $user->pseudo ?>&afficheImg=<?= $value->image_article ?>&afficheDate=<?= $value->date_heure ?>" class="btn btn-primary">Voir</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
