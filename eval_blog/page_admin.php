...
<body>
    ...
    if (isset($_GET['delete'])) {
        $id = requete_id($_GET['delete']);
        unlink('img/' . $id->image_article);
        requete_delete($_GET['delete']);
        echo 'User effacer !';
    }
            ...
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <form action="creation.php">
                        <button class="btn btn-primary my-2" name="">Créer un article</button>
                    </form>
                    </p>
                </div>
            </div>
                            ...
                            <div class="col">
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <small class="text-muted">Le <?= date("d/m/Y H:i:s", strtotime($value->date_heure)) ?></small>
                                        <div class="btn-group my-3">
                                            <a href="page_admin.php?delete=<?= $value->id_article ?>" onclick="return confirm('Etes vous certian de vouloir effacer cet article ?');" class="btn btn-danger">Effacer</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
